...
data class SchoolsObjectsInfo(
    val schoolObjectName: String,
    val url: String
)

data class SchoolObjects(
    val schoolObject: MutableMap<Int, SchoolsObjectsInfo>
) {
    companion object {
        val schoolObjects = mutableMapOf(
            1 to SchoolsObjectsInfo(
                "whale",
                "https://hqxnhnvyszcurgvssbai.supabase.co/storage/v1/object/public/Card%20Images/Animals/balena.webp"
            ),
            2 to SchoolsObjectsInfo(
                "dog",
            ...
            4 to SchoolsObjectsInfo(
                "rabbit",
                "https://hqxnhnvyszcurgvssbai.supabase.co/storage/v1/object/public/Card%20Images/Animals/canguro.webp?t=2023-09-16T12%3A27%3A19.763Z"
            ),
            5 to SchoolsObjectsInfo(
                "dolphin",
